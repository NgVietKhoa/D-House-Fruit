...
declare global {
  ...
  const { useChatBot }: typeof import('../../composables/useChatBot')
  const { useFetch, useLazyFetch }: typeof import('../../node_modules/nuxt/dist/app/composables/fetch')
  const { useGiftBaskets }: typeof import('../../composables/useGiftBaskets')
  ...
  const { useOrders }: typeof import('../../composables/useOrders')
  const { usePreviewMode }: typeof import('../../node_modules/nuxt/dist/app/composables/preview')
  const { useProducts }: typeof import('../../composables/useProducts')
